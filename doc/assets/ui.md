...
- `client/public/portraits/steward.webp` — 영지 관리인 Aldwin의 거래 창 초상화; 사용자 제공 OpenAI ChatGPT 생성 이미지, ChatGPT Pro x20 등급, 생성 2026-09-07(제공 파일명 기준); project-owned. 제공 파일 `assets/ChatGPT Image 2026년 9월 7일 오후 03_25_34.png`를 `../images/characters/steward-portrait.png`에 원본 보관(1337×1177 PNG, alpha 포함). 배포본은 512×451 WebP q88, alpha와 원본 비율 유지(2026-09-07 등록). `traderId=steward`로 자동 연결
