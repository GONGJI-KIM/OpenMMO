...
- Presentation: 0.3 seconds gathering and 0.3 seconds dispersing. Local weapons follow the hand bone; remote weapons use a hand-height offset from the interpolated player pose. Armor uses a torso anchor.
