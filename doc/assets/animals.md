...
| `turn_right_180` | 163–277 | 164–278 | 약 180도 우회전, 내보내기만 하고 런타임 미사용 |
| 중복 걷기 | 278–359 | 279–360 | 앞 걷기와 48개 본 위치가 동일해 제외 |
| `turn_right_90` | 360–435 | 361–436 | 약 90도 우회전, 내보내기만 하고 런타임 미사용 |
| `idle` | 436–936 | 437–937 | 대기·고개 움직임·앞발 들기 |

GLB에는 중복 걷기를 제외한 5개 클립을 0프레임부터 다시 베이크했다.
원본의 추가 938프레임은 사용자 지정 끝 범위 밖이므로 제외했다.
게임에서는 속도에 따라 idle/walk/run을 전환하고, 방향은 기존 이동 코드가 제어한다.
두 회전 클립의 리그 회전은 보존했다.
